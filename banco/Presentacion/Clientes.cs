    ...
    public partial class frmClientes : Form
    {
        ...
        private void btnGrabarClientes_Click_1(object sender, EventArgs e)
        {
            if (ValidarCliente())
            {
                ...
                if (!ExisteCliente(c))
                {
                    ...
                    if (oBD.EjecutarSP("sp_ingresarCliente", lParametros) > 0)
                    {
                ...
                else
                {
                    ...
                    if (oBD.EjecutarSP("sp_actualizarCliente", lParametros) > 0) MessageBox.Show("Se ha podido actualizar el cliente");
        ...
        private void btnEliminarClientes_Click_1(object sender, EventArgs e)
        {
                ...
                == DialogResult.Yes)
            {
                ...
                if (oBD.EjecutarEliminarSP("Sp_eliminarCliente", lClientes[lstClientes.SelectedIndex].pDni, -1)) MessageBox.Show("se pudo eliminar el Cliente");
